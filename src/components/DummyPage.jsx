...
export default function DummyPage({ title }) {
  return (
    <div className="w-full max-w-4xl bg-white/50 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-lg border border-white/40">
      <div className="flex items-center gap-4 mb-8 border-b border-[#0a0f1d]/10 pb-6">
        <Link 
          to="/" 
      ...
      <div className="flex flex-col items-center justify-center py-20 border-2 border-dashed border-[#0a0f1d]/20 rounded-2xl bg-white/30">
